...
<html>
  <head>
    <script defer data-domain="wheretolive.la" data-api="https://steep-lab-ecee.automateordie.workers.dev/wheretolivedotla/event" src="https://steep-lab-ecee.automateordie.workers.dev/wheretolivedotla/script.js"</script>
    {%metas%}
    <title>{%title%}</title>
    {%favicon%}
    {%css%}
