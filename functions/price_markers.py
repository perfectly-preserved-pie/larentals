...
build_price_marker = assign(
    ...
    const foreground = scale ? scale.labelColorFor(price) : '#ffffff';
    ...
    const dataAttrs = ' data-mls="' + esc(props.mls_number) + '"'
        ...
        + ' data-lat="' + esc(latlng.lat) + '"'
        + ' data-lng="' + esc(latlng.lng) + '"'
    ...
    const marker = L.marker(latlng, {
        icon: L.divIcon({
            ...
            html: '<span class="price-marker" style="background:' + background + ';color:' + foreground + '"'
