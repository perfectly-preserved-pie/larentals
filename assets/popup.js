        ...
        on_each_feature: function(feature, layer, context) {
            ...
            if (feature.properties.popup) {
                layer.bindPopup(feature.properties.popup, {
                    ...
                    //autoPan: false,
                    //closeButton: false,
                    // Set the maxHeight to 450px if the device is mobile, otherwise use the default value
                    maxHeight: window.innerWidth < 768 ? 450 : 650, 
                    // Set the maxWidth to 400px if the device is mobile, otherwise use the default value
                    maxWidth: window.innerWidth < 768 ? 400 : 300,
                })
            }
        }
    }
