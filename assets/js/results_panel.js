...
(function () {
    ...
    function collectVisible() {
        ...
        for (var i = 0; i < markers.length; i += 1) {
            ...
            rows.push({
                el: el,
                latlng: [Number(el.getAttribute("data-lat")), Number(el.getAttribute("data-lng"))],
    ...
    function refresh() {
        ...
        var count = document.querySelector("[data-results-panel] .results-panel__count:not(.match-count)");
        if (!list) return;
